...
public:
	...
	struct Ck { static void connect();
		static_assert(
			...
			"GpioB3::Ck only connects to I2s1!");
	};
	template< Peripheral peripheral >
	struct G5Io1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioB3::G5Io1 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct Sck { static void connect();
		static_assert(
			(peripheral == Peripheral::Spi1),
			"GpioB3::Sck only connects to Spi1!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioB3::G5Io1<Peripheral::Tsc>
{
	using Gpio = GpioB3;

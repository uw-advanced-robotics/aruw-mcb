...
public:
	...
	struct G3Io1 { static void connect();
		static_assert(
			...
			"GpioC5::G3Io1 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct In15 { static void connect();
		static_assert(
			(peripheral == Peripheral::Adc),
			"GpioC5::In15 only connects to Adc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioC5::G3Io1<Peripheral::Tsc>
{
	using Gpio = GpioC5;
...
template<>
struct GpioC5::In15<Peripheral::Adc>
{
	using Gpio = GpioC5;
...
template<>
constexpr int8_t
GpioC5::AdcChannel<Peripheral::Adc> = 15;
template<>

...
public:
	...
	struct Cec { static void connect();
		static_assert(
			...
			"GpioB8::Cec only connects to None!");
	};
	template< Peripheral peripheral >
	...
	struct Rx { static void connect();
		static_assert(
			...
			"GpioB8::Rx only connects to Can!");
	};
	template< Peripheral peripheral >
	...
	struct Sync { static void connect();
		static_assert(
			...
			"GpioB8::Sync only connects to Tsc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioB8::Cec<Peripheral::None>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Rx<Peripheral::Can>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Sync<Peripheral::Tsc>
{
	using Gpio = GpioB8;

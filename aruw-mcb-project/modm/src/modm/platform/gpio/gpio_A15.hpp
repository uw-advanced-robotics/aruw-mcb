...
public:
	...
	struct De { static void connect();
		static_assert(
			...
			"GpioA15::De only connects to Usart4!");
	};
	template< Peripheral peripheral >
	...
	struct Nss { static void connect();
		static_assert(
			...
			"GpioA15::Nss only connects to Spi1!");
	};
	template< Peripheral peripheral >
	struct Rts { static void connect();
		static_assert(
			(peripheral == Peripheral::Usart4),
			"GpioA15::Rts only connects to Usart4!");
	};
	template< Peripheral peripheral >
	...
	struct Ws { static void connect();
		static_assert(
			...
			"GpioA15::Ws only connects to I2s1!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA15::De<Peripheral::Usart4>
{
	using Gpio = GpioA15;
...
template<>
struct GpioA15::Rts<Peripheral::Usart4>
{
	using Gpio = GpioA15;

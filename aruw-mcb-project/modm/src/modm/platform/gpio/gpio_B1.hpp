...
public:
	...
	struct Ch1 { static void connect();
		static_assert(
			...
			"GpioB1::Ch1 only connects to Tim14!");
	};
	template< Peripheral peripheral >
	...
	struct G3Io3 { static void connect();
		static_assert(
			...
			"GpioB1::G3Io3 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct In9 { static void connect();
		static_assert(
			(peripheral == Peripheral::Adc),
			"GpioB1::In9 only connects to Adc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB1::Ch1<Peripheral::Tim14>
{
	using Gpio = GpioB1;
...
template<>
struct GpioB1::G3Io3<Peripheral::Tsc>
{
	using Gpio = GpioB1;
...
template<>
struct GpioB1::In9<Peripheral::Adc>
{
	using Gpio = GpioB1;
...
template<>
constexpr int8_t
GpioB1::AdcChannel<Peripheral::Adc> = 9;
template<>

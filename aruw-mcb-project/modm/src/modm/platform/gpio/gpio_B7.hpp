...
public:
	...
	struct Cts { static void connect();
		static_assert(
			...
			"GpioB7::Cts only connects to Usart4!");
	};
	template< Peripheral peripheral >
	struct G5Io4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioB7::G5Io4 only connects to Tsc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB7::Cts<Peripheral::Usart4>
{
	using Gpio = GpioB7;
...
template<>
struct GpioB7::G5Io4<Peripheral::Tsc>
{
	using Gpio = GpioB7;

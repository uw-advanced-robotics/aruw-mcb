...
public:
	...
	struct Cec { static void connect();
		static_assert(
			...
			"GpioA5::Cec only connects to None!");
	};
	template< Peripheral peripheral >
	...
	struct G2Io2 { static void connect();
		static_assert(
			...
			"GpioA5::G2Io2 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct In5 { static void connect();
		static_assert(
			(peripheral == Peripheral::Adc),
			"GpioA5::In5 only connects to Adc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioA5::Cec<Peripheral::None>
{
	using Gpio = GpioA5;
...
template<>
struct GpioA5::G2Io2<Peripheral::Tsc>
{
	using Gpio = GpioA5;
...
template<>
struct GpioA5::In5<Peripheral::Adc>
{
	using Gpio = GpioA5;
...
template<>
constexpr int8_t
GpioA5::AdcChannel<Peripheral::Adc> = 5;
template<>

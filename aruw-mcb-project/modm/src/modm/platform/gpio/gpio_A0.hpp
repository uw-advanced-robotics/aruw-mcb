...
public:
	...
	struct G1Io1 { static void connect();
		static_assert(
			...
			"GpioA0::G1Io1 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct In0 { static void connect();
		static_assert(
			(peripheral == Peripheral::Adc),
			"GpioA0::In0 only connects to Adc!");
	};
	template< Peripheral peripheral >
	...
	struct Tx { static void connect();
		static_assert(
			...
			"GpioA0::Tx only connects to Usart4!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioA0::G1Io1<Peripheral::Tsc>
{
	using Gpio = GpioA0;
...
template<>
struct GpioA0::In0<Peripheral::Adc>
{
	using Gpio = GpioA0;
...
template<>
constexpr int8_t
GpioA0::AdcChannel<Peripheral::Adc> = 0;
template<>
...
template<>
struct GpioA0::Tx<Peripheral::Usart4>
{
	using Gpio = GpioA0;

...
template<>
struct GpioA6::G2Io3<Peripheral::Tsc>
{
	using Gpio = GpioA6;
...
template<>
struct GpioA6::In6<Peripheral::Adc>
{
	using Gpio = GpioA6;
...
template<>
constexpr int8_t
GpioA6::AdcChannel<Peripheral::Adc> = 6;
template<>
struct GpioA6::Mck<Peripheral::I2s1>
{
	using Gpio = GpioA6;

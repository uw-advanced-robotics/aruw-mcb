...
#ifndef TAPROOT_SETPOINT_INTEGRAL_CONTINUOUS_JAM_CHECKER_HPP_
#define TAPROOT_SETPOINT_INTEGRAL_CONTINUOUS_JAM_CHECKER_HPP_
 ...
 */
class SetpointIntegralContinuousJamChecker
{
public:
    /**
     ...
     */
    SetpointIntegralContinuousJamChecker(
        SetpointSubsystem* setpointSubsystem,
        const float distanceTolerance,
        const uint32_t temporalTolerance)
        : setpointSubsystem(setpointSubsystem),
    ...
    inline bool check()
    {
        ...
        if (!tap::algorithms::compareFloatClose(currentValue, 0, 1E-5))
        {
            withinTolerance = tap::algorithms::compareFloatClose(
...
#endif  // TAPROOT_SETPOINT_INTEGRAL_CONTINUOUS_JAM_CHECKER_HPP_

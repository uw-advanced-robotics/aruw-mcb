...
struct MagCalibration
{
    ...
    int8_t iMagBufferReadOnly;        ///< flag to denote that the magnetic measurement buffer is
                                      ///< temporarily read only
    int8_t i4ElementSolverTried;      ///< flag to denote at least one attempt made with 4 element
                                      ///< calibration
    int8_t i7ElementSolverTried;      ///< flag to denote at least one attempt made with 4 element
                                      ///< calibration
    int8_t i10ElementSolverTried;     ///< flag to denote at least one attempt made with 4 element
                                      ///< calibration
};
...
///@{
void fInitializeMagCalibration(
...
void fRunMagCalibration(
    ...
    struct MagSensor *pthisMag,
    int32_t loopcounter);
void fUpdateMagCalibration4(
    struct MagCalibration *pthisMagCal,
    struct MagBuffer *pthisMagBuffer,
    struct MagSensor *pthisMag);
void fUpdateMagCalibration7(
    struct MagCalibration *pthisMagCal,
    struct MagBuffer *pthisMagBuffer,
    struct MagSensor *pthisMag);
void fUpdateMagCalibration10(
    struct MagCalibration *pthisMagCal,
    struct MagBuffer *pthisMagBuffer,
    struct MagSensor *pthisMag);

...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE7::D4 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Da4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE7::Da4 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart7), "GpioE7::Rx only connects to Uart7!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

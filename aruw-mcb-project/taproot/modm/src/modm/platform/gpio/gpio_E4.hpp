...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE4::A20 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct D4
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioE4::Fsa only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE4::Nss only connects to Spi4!");
    };
    template <Peripheral peripheral>
    struct Traced1
    {

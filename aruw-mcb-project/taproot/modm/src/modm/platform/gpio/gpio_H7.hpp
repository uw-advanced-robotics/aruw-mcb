...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioH7::D9 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioH7::Miso only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Rxd3
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioH7::Sdcke1 only connects to Fmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioD6::D10 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Mosi
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi3), "GpioD6::Mosi only connects to Spi3!");
    };
    template <Peripheral peripheral>
    struct Nwait
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioD6::Nwait only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioD6::Sd only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioD6::Sda only connects to Sai1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

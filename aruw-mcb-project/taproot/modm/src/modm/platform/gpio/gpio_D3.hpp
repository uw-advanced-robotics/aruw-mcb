...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioD3::Ck only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Clk
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioD3::Clk only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioD3::D5 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioD3::Sck only connects to Spi2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

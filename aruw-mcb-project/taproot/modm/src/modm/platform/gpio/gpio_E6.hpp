...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE6::A22 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Ch2
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE6::Mosi only connects to Spi4!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioE6::Sda only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct Traced3
    {

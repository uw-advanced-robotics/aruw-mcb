...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE5::A21 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Ch1
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE5::Miso only connects to Spi4!");
    };
    template <Peripheral peripheral>
    struct Scka
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioE5::Scka only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct Traced2
    {

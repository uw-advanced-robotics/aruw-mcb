...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioF11::Mosi only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Sdnras
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioF11::Sdnras only connects to Fmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

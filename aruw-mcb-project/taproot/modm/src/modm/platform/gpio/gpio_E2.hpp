...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE2::A23 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Mclka
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioE2::Mclka only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE2::Sck only connects to Spi4!");
    };
    template <Peripheral peripheral>
    struct Traceclk
    {

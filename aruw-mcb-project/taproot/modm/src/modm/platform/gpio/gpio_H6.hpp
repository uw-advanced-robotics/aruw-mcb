...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioH6::D8 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Rxd2
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioH6::Sck only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Sdne1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioH6::Sdne1 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Smba
    {

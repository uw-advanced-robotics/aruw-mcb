...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioG9::Nce3 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Ne2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioG9::Ne2 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioG9::Vsync only connects to Dcmi!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

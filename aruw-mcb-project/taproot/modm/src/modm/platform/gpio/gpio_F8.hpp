...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioF8::Miso only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Niowr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioF8::Niowr only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Sckb
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioF8::Sckb only connects to Sai1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

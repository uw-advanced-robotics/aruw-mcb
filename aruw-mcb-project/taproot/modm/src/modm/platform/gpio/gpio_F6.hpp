...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioF6::Niord only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioF6::Nss only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart7), "GpioF6::Rx only connects to Uart7!");
    };
    template <Peripheral peripheral>
    struct Sdb
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioF6::Sdb only connects to Sai1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

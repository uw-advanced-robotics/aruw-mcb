...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE13::D10 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Da10
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE13::Da10 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE13::Miso only connects to Spi4!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

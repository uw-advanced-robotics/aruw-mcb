...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE11::D8 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Da8
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE11::Da8 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE11::Nss only connects to Spi4!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

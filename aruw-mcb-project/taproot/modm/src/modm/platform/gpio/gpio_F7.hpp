...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioF7::Mclkb only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct Nreg
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioF7::Nreg only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioF7::Sck only connects to Spi5!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart7), "GpioF7::Tx only connects to Uart7!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

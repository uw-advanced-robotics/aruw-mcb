...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE8::D5 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Da5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE8::Da5 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart7), "GpioE8::Tx only connects to Uart7!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

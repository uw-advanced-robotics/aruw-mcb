...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioF9::Cd only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Ch1
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sai1), "GpioF9::Fsb only connects to Sai1!");
    };
    template <Peripheral peripheral>
    struct In7
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi5), "GpioF9::Mosi only connects to Spi5!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

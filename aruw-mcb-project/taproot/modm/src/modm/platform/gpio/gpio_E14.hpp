...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE14::D11 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Da11
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fmc), "GpioE14::Da11 only connects to Fmc!");
    };
    template <Peripheral peripheral>
    struct Mosi
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi4), "GpioE14::Mosi only connects to Spi4!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>

...
// ----------------------------------------------------------------------------
bool
modm::platform::Timer5::isChannelConfiguredAsInput(uint32_t channel)
{
	bool isInput = false;
	switch (channel) {
		case 1:
			isInput = TIM5->CCMR1 & TIM_CCMR1_CC1S;
			break;
		case 2:
			isInput = TIM5->CCMR1 & TIM_CCMR1_CC2S;
			break;
		case 3:
			isInput = TIM5->CCMR2 & TIM_CCMR2_CC3S;
			break;
		case 4:
			isInput = TIM5->CCMR2 & TIM_CCMR2_CC4S;
			break;
		default:
			break;
	}

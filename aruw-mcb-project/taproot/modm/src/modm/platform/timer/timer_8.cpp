...
// ----------------------------------------------------------------------------
void modm::platform::Timer8::enable() { Rcc::enable<Peripheral::Tim8>(); }

void modm::platform::Timer8::disable()
{
    TIM8->CR1 = 0;
    TIM8->DIER = 0;
    TIM8->CCER = 0;
...
// ----------------------------------------------------------------------------
void modm::platform::Timer8::setMode(
    Mode mode,
    SlaveMode slaveMode,
    ...
    MasterMode masterMode)
{
    ...
    TIM8->SMCR = static_cast<uint32_t>(slaveMode) | static_cast<uint32_t>(slaveModeTrigger);
}

// ----------------------------------------------------------------------------
void modm::platform::Timer8::configureInputChannel(
    uint32_t channel,
...
// ----------------------------------------------------------------------------
void modm::platform::Timer8::configureOutputChannel(
    uint32_t channel,
...
void modm::platform::Timer8::configureOutputChannel(uint32_t channel, uint32_t modeOutputPorts)
{
    channel -= 1;  // 1..4 -> 0..3
...
// ----------------------------------------------------------------------------
void modm::platform::Timer8::enableInterruptVector(
    Interrupt interrupt,
    bool enable,
    uint32_t priority)
{

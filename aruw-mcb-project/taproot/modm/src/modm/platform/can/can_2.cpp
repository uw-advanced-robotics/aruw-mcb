...
// ----------------------------------------------------------------------------
bool modm::platform::Can2::initializeWithPrescaler(
    uint16_t prescaler,
    uint8_t bs1,
    uint8_t bs2,
    ...
    bool overwriteOnOverrun)
{
    ...
    CAN2->BTR = ((1 - 1) << CAN_BTR_SJW_POS) |    // SJW (1 to 4 possible)
...
void modm::platform::Can2::setMode(Mode mode)
{
    ...
    CAN2->BTR = (CAN2->BTR & ~(CAN_BTR_SILM | CAN_BTR_LBKM)) | static_cast<uint32_t>(mode);
...
// ----------------------------------------------------------------------------
void modm::platform::Can2::setAutomaticRetransmission(bool retransmission)
{
    if (retransmission)
    {
...
// ----------------------------------------------------------------------------
bool modm::platform::Can2::isMessageAvailable() { return rxQueue.isNotEmpty(); }

// ----------------------------------------------------------------------------
bool modm::platform::Can2::getMessage(can::Message& message, uint8_t* filter_id)
{
    if (rxQueue.isEmpty())
    {
...
// ----------------------------------------------------------------------------
bool modm::platform::Can2::isReadyToSend() { return txQueue.isNotFull(); }

// ----------------------------------------------------------------------------
bool modm::platform::Can2::sendMessage(const can::Message& message)
{
...
// ----------------------------------------------------------------------------
modm::platform::Can2::BusState modm::platform::Can2::getBusState()
{
...
// ----------------------------------------------------------------------------
void modm::platform::Can2::enableStatusChangeInterrupt(

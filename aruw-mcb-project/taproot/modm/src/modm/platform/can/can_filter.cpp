...
// ----------------------------------------------------------------------------
void modm::platform::CanFilter::setFilterBase(
    uint8_t bank,
    uint32_t flags,
    uint32_t fr1,
    uint32_t fr2)
...
void modm::platform::CanFilter::disableFilter(uint8_t id)
{
...
// ----------------------------------------------------------------------------
void modm::platform::CanFilter::setStartFilterBankForCan2(uint8_t startBank)
{
    // Initialization mode for the filter
    CAN1->FMR |= CAN_FMR_FINIT;

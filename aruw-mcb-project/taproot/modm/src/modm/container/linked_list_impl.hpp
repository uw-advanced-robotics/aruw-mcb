...
template <typename T, typename Allocator>
bool modm::LinkedList<T, Allocator>::isEmpty() const
{
    return (this->front == 0);
}
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
bool modm::LinkedList<T, Allocator>::prepend(const T& value)
{
...
template <typename T, typename Allocator>
bool modm::LinkedList<T, Allocator>::append(const T& value)
{
    // allocate memory for the new node and copy the value into it
    Node* node = this->nodeAllocator.allocate(1);
    Allocator::construct(&node->value, value);
...
template <typename T, typename Allocator>
bool modm::LinkedList<T, Allocator>::insert(const_iterator pos, const T& value)
{
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
void modm::LinkedList<T, Allocator>::removeFront()
{
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
inline const T& modm::LinkedList<T, Allocator>::getFront() const
{
    return this->front->value;
}

template <typename T, typename Allocator>
inline T& modm::LinkedList<T, Allocator>::getFront()
{
    return this->front->value;
}

template <typename T, typename Allocator>
inline const T& modm::LinkedList<T, Allocator>::getBack() const
{
    return this->back->value;
}

template <typename T, typename Allocator>
inline T& modm::LinkedList<T, Allocator>::getBack()
{
    return this->back->value;
}
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
void modm::LinkedList<T, Allocator>::removeAll()
{
    while (!this->isEmpty())
    {
        this->removeFront();
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
typename modm::LinkedList<T, Allocator>::iterator modm::LinkedList<T, Allocator>::remove(
    const iterator& iter)
{
    if (this->isEmpty())
    {

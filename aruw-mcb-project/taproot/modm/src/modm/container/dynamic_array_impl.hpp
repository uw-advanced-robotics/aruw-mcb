...
template <typename T, typename Allocator>
modm::DynamicArray<T, Allocator>& modm::DynamicArray<T, Allocator>::operator=(
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
void modm::DynamicArray<T, Allocator>::relocate(SizeType n)
{
    this->capacity = n;
...
// ----------------------------------------------------------------------------
template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::iterator modm::DynamicArray<T, Allocator>::begin()
{
    return iterator(this, 0);
}

template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::iterator modm::DynamicArray<T, Allocator>::end()
{
    return iterator(this, size);
}

template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::iterator modm::DynamicArray<T, Allocator>::find(
    const T& value)
{
...
template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::const_iterator modm::DynamicArray<T, Allocator>::begin()
    const
{
...
template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::const_iterator modm::DynamicArray<T, Allocator>::end()
    const
{
...
template <typename T, typename Allocator>
typename modm::DynamicArray<T, Allocator>::const_iterator modm::DynamicArray<T, Allocator>::find(
    const T& value) const
{

...
// ----------------------------------------------------------------------------
template <typename T>
modm::LineSegment2D<T>::LineSegment2D() : startPoint(),
                                          endPoint()
{
}
...
// ----------------------------------------------------------------------------
template <typename T>
inline void modm::LineSegment2D<T>::setStartPoint(const Vector<T, 2>& point)
{
    this->startPoint = point;
}

template <typename T>
inline const modm::Vector<T, 2>& modm::LineSegment2D<T>::getStartPoint() const
{
    return this->startPoint;
}

template <typename T>
inline void modm::LineSegment2D<T>::setEndPoint(const Vector<T, 2>& point)
{
    this->endPoint = point;
}

template <typename T>
inline const modm::Vector<T, 2>& modm::LineSegment2D<T>::getEndPoint() const
{
    return this->endPoint;
}

template <typename T>
inline void modm::LineSegment2D<T>::set(const Vector<T, 2>& start, const Vector<T, 2>& end)
{
...
// ----------------------------------------------------------------------------
template <typename T>
void modm::LineSegment2D<T>::translate(const Vector<T, 2>& vector)
{
...
// ----------------------------------------------------------------------------
template <typename T>
T modm::LineSegment2D<T>::getLength() const
{
...
// ----------------------------------------------------------------------------
template <typename T>
modm::Vector<T, 2> modm::LineSegment2D<T>::getDirectionVector() const
{
...
// ----------------------------------------------------------------------------
template <typename T>
const T modm::LineSegment2D<T>::getDistanceTo(const Vector<T, 2>& point) const
{
...
// ----------------------------------------------------------------------------
template <typename T>
const modm::Vector<T, 2> modm::LineSegment2D<T>::getClosestPointTo(const Vector<T, 2>& point) const
{
    // vector from the base point of the line to the new point
    Vector<T, 2> startToPoint = point - this->startPoint;
    Vector<T, 2> directionVector = this->endPoint - this->startPoint;
...
{
    return (
        ((Vector<T, 2>::ccw(this->startPoint, this->endPoint, other.startPoint) *
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::LineSegment2D<T>::intersects(const Polygon2D<T>& polygon) const
{
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::LineSegment2D<T>::getIntersections(
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::LineSegment2D<T>::operator==(const LineSegment2D& other) const
{

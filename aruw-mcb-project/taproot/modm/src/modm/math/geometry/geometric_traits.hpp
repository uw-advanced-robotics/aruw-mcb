...
struct GeometricTraits
{
     ...
     */
    static inline T round(float value) { return ::round(value); }
};
...
struct GeometricTraits<int8_t>
{
    ...
    static inline int8_t round(float value) { return ::round(value); }
};
...
struct GeometricTraits<uint8_t>
{
    ...
    static inline uint8_t round(float value) { return ::round(value); }
};
...
struct GeometricTraits<int16_t>
{
    ...
    static inline int16_t round(float value) { return ::round(value); }
};
...
struct GeometricTraits<int32_t>
{
    ...
    static inline int32_t round(float value) { return ::round(value); }
};
...
struct GeometricTraits<float>
{
    ...
    static inline float round(float value) { return value; }
};
...
struct GeometricTraits<double>
{
    ...
    static inline double round(double value) { return value; }
};
}  // namespace modm

...
{
// forward declaration
template <typename T, uint8_t W, uint8_t H>
class Matrix;
...
#define IMPLEMENT_VECTOR_ACCESSOR2(a, b) \
    Vector<T, 2> a##b() const { return Vector<T, 2>(a, b); }

#define IMPLEMENT_VECTOR_ACCESSOR3(a, b, c) \
    Vector<T, 3> a##b##c() const { return Vector<T, 3>(a, b, c); }

#define IMPLEMENT_VECTOR_ACCESSOR4(a, b, c, d) \
    Vector<T, 4> a##b##c##d() const { return Vector<T, 4>(a, b, c, d); }

...
// ----------------------------------------------------------------------------
template <typename T>
modm::filter::Median<T, 9>::Median(const T& initialValue) : index(0)
{
...
template <typename T>
void modm::filter::Median<T, 9>::append(const T& input)
{
...
template <typename T>
void modm::filter::Median<T, 9>::update()
{
...
template <typename T>
const T modm::filter::Median<T, 9>::getValue() const
{
    return sorted[4];
}

...
public:
    ...
    struct Parameter
    {
        ...
        inline void setKp(float kp) { this->kp = static_cast<T>(kp * ScaleFactor); }

        inline void setKi(float ki) { this->ki = static_cast<T>(ki * ScaleFactor); }

        inline void setKd(float kd) { this->kd = static_cast<T>(kd * ScaleFactor); }

        inline void setMaxErrorSum(float maxErrorSum)
        {
...
public:
     ...
     * \endcode
     */
    inline const T& getLastError() const { return this->lastError; }
     ...
     * This function is provided for debugging purposes only.
     */
    inline const T& getErrorSum() const { return this->errorSum; }

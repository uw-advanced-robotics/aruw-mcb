...
#define modm_assert_continue_ignore_debug(condition, ...)         \
    ({                                                            \
        bool modm_unused evaluated_condition = (bool)(condition); \
        evaluated_condition;                                      \
    })
#define modm_assert_continue_fail_debug(condition, ...) modm_assert_continue_ignore_debug(condition)

...
// ----------------------------------------------------------------------------
xpcc::DynamicPostman::DeliverInfo xpcc::DynamicPostman::deliverPacket(
    const Header& header,
    const modm::SmartPointer& payload)
{
    ...
    else
    {
        ...
        {
            CallbackMap::const_iterator iterCallback(
                iterDestination->second.find(header.packetIdentifier));
...
// ----------------------------------------------------------------------------
xpcc::DynamicPostman::EventListener::EventListener() : hasPayload(-1) {}

xpcc::DynamicPostman::EventListener::EventListener(EventCallback call) : call(call), hasPayload(1)
{
}
...
void xpcc::DynamicPostman::EventListener::operator()(
    const Header& header,
...
// ----------------------------------------------------------------------------
xpcc::DynamicPostman::ActionHandler::ActionHandler() : hasPayload(-1) {}

xpcc::DynamicPostman::ActionHandler::ActionHandler(ActionCallback call) : call(call), hasPayload(1)
{
}
...
void xpcc::DynamicPostman::ActionHandler::operator()(

...
// ----------------------------------------------------------------------------
template <typename T>
modm::Polygon2D<T>::Polygon2D(SizeType n) : PointSet2D<T>(n)
{
}

template <typename T>
modm::Polygon2D<T>::Polygon2D(const Polygon2D<T>& other) : PointSet2D<T>(other)
{
}
...
template <typename T>
modm::Polygon2D<T>& modm::Polygon2D<T>::operator=(const Polygon2D<T>& other)
{
...
// ----------------------------------------------------------------------------
template <typename T>
modm::Polygon2D<T>& modm::Polygon2D<T>::operator<<(const modm::Polygon2D<T>::PointType& point)
{
    this->append(point);
    return *this;
}
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::intersects(const Polygon2D& other) const
{
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::intersects(const Circle2D<T>& circle) const
{
    SizeType n = this->points.getSize();
    for (SizeType i = 0; i < n; ++i)
    {
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::intersects(const LineSegment2D<T>& segment) const
{
    SizeType n = this->points.getSize();
    for (SizeType i = 0; i < n; ++i)
    {
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::intersects(const Ray2D<T>& segment) const
{
    SizeType n = this->points.getSize();
    for (SizeType i = 0; i < n; ++i)
    {
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::getIntersections(
    const LineSegment2D<T>& segment,
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Polygon2D<T>::isInside(const modm::Polygon2D<T>::PointType& point)
{
    bool cw = true;
    bool ccw = true;

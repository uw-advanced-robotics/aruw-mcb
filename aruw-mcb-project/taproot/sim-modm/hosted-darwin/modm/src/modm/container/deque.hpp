...
public:
     ...
     */
    inline T& get(Index n);

    inline const T& get(Index n) const;
     ...
     * 			Other indexes will cause undefined behaviour.
     */
    inline T& operator[](Index n);

    inline const T& operator[](Index n) const;
     ...
     * 			Other indexes will cause undefined behaviour.
     */
    inline T& rget(Index n);

    inline const T& rget(Index n) const;

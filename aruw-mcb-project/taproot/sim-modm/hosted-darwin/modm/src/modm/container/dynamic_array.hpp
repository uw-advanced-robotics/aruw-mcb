...
public:
     ...
     */
    inline SizeType getSize() const { return this->size; }
     ...
     * \see	getSize()
     */
    inline SizeType getCapacity() const { return this->capacity; }
     ...
     * \see	append()
     */
    inline T& operator[](SizeType index) { return this->values[index]; }
     ...
     * dynamic array container.
     */
    inline const T& operator[](SizeType index) const { return this->values[index]; }
    ...
    inline const T& getFront() const { return this->values[0]; }

    inline T& getFront() { return this->values[0]; }

    inline const T& getBack() const { return this->values[this->size - 1]; }

    inline T& getBack() { return this->values[this->size - 1]; }

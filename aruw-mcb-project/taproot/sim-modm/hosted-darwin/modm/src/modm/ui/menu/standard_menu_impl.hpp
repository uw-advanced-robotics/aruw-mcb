...
modm::MenuEntry<Allocator>::MenuEntry(
    const char* text,
    uint16_t space,
...
template <typename Allocator>
modm::StandardMenu<Allocator>::StandardMenu(
...
template <typename Allocator>
void modm::StandardMenu<Allocator>::addEntry(const char* text, MenuEntryCallback<Allocator> func)
{
...
template <typename Allocator>
void modm::StandardMenu<Allocator>::setTitle(const char* text)
{
    this->title = text;
}

template <typename Allocator>
void modm::StandardMenu<Allocator>::draw()
{
    ...
    {
        if (this->homePosition + i >= count) break;
...
template <typename Allocator>
bool modm::StandardMenu<Allocator>::hasChanged()
{
...
template <typename Allocator>
void modm::StandardMenu<Allocator>::selectedEntryFunction(uint8_t /*selected*/)
{
}

template <typename Allocator>
void modm::StandardMenu<Allocator>::shortButtonPress(modm::MenuButtons::Button button)
{
    switch (button)
    {

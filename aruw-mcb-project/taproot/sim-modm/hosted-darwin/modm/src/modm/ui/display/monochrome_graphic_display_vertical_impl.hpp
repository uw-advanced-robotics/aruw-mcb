...
void modm::MonochromeGraphicDisplayVertical<Width, Height>::drawHorizontalLine(
    glcd::Point start,
    uint16_t length)
{
...
template <int16_t Width, int16_t Height>
void modm::MonochromeGraphicDisplayVertical<Width, Height>::drawVerticalLine(
    glcd::Point start,
    uint16_t length)
{
...
template <int16_t Width, int16_t Height>
void modm::MonochromeGraphicDisplayVertical<Width, Height>::drawImageRaw(
    glcd::Point start,
    uint16_t width,
    uint16_t height,
...
template <int16_t Width, int16_t Height>
void modm::MonochromeGraphicDisplayVertical<Width, Height>::setPixel(int16_t x, int16_t y)
{
    if (x < Width and y < Height)
    {
...
template <int16_t Width, int16_t Height>
void modm::MonochromeGraphicDisplayVertical<Width, Height>::clearPixel(int16_t x, int16_t y)
{
    if (x < Width and y < Height)
    {
        this->buffer[y / 8][x] &= ~(1 << y % 8);
...
template <int16_t Width, int16_t Height>
bool modm::MonochromeGraphicDisplayVertical<Width, Height>::getPixel(int16_t x, int16_t y) const
{
    if (x < Width and y < Height)
    {

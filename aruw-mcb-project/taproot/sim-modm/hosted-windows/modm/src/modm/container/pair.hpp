...
public:
    ...
    FirstType& getFirst() { return first; }

    const FirstType& getFirst() const { return first; }

    SecondType& getSecond() { return second; }

    const SecondType& getSecond() const { return second; }

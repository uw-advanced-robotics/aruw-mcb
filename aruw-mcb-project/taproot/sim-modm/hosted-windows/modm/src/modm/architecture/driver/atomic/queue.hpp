...
public:
    ...
    modm_always_inline bool isFull() const;

    modm_always_inline bool isNotFull() const { return not isFull(); }
    ...
    modm_always_inline bool isEmpty() const;

    modm_always_inline bool isNotEmpty() const { return not isEmpty(); }
    ...
    modm_always_inline Size getMaxSize() const;

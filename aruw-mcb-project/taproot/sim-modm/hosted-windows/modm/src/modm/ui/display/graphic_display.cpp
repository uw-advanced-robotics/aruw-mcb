...
// ----------------------------------------------------------------------------
void modm::GraphicDisplay::drawLine(int16_t x1, int16_t y1, int16_t x2, int16_t y2)
{
    if (x1 == x2)
    {
...
void modm::GraphicDisplay::drawHorizontalLine(glcd::Point start, uint16_t length)
{
...
void modm::GraphicDisplay::drawVerticalLine(glcd::Point start, uint16_t length)
{
...
void modm::GraphicDisplay::drawRectangle(glcd::Point start, uint16_t width, uint16_t height)
{
...
void modm::GraphicDisplay::drawRoundedRectangle(
    glcd::Point start,
    uint16_t width,
    uint16_t height,
    uint16_t radius)
{
    if (radius == 0)
    {
        this->drawRectangle(start, width, height);
    }
...
void modm::GraphicDisplay::drawCircle(glcd::Point center, uint16_t radius)
{
    if (radius == 0)
    {
        return;
...
void modm::GraphicDisplay::drawCircle4(glcd::Point center, int16_t x, int16_t y)
{
...
void modm::GraphicDisplay::drawEllipse(glcd::Point center, int16_t rx, int16_t ry)
{
    int32_t rx_2 = rx * rx;
    int32_t ry_2 = ry * ry;
...
// ----------------------------------------------------------------------------
void modm::GraphicDisplay::drawImage(glcd::Point start, modm::accessor::Flash<uint8_t> image)
{
...
void modm::GraphicDisplay::drawImageRaw(
    glcd::Point start,
    uint16_t width,
    uint16_t height,

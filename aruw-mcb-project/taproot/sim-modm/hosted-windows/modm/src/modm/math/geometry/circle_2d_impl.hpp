...
// ----------------------------------------------------------------------------
template <typename T>
modm::Circle2D<T>::Circle2D() : center(),
                                radius(0)
{
}
...
// ----------------------------------------------------------------------------
template <typename T>
inline const modm::Vector<T, 2>& modm::Circle2D<T>::getCenter() const
{
    return this->center;
}

template <typename T>
inline void modm::Circle2D<T>::setCenter(const Vector<T, 2>& point)
{
    this->center = point;
}

template <typename T>
inline T modm::Circle2D<T>::getRadius() const
{
    return this->radius;
}

template <typename T>
inline void modm::Circle2D<T>::setRadius(T newRadius)
{
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Circle2D<T>::intersects(const Polygon2D<T>& polygon) const
{
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Circle2D<T>::getIntersections(const Circle2D& other, PointSet2D<T>& intersections) const
{
    ...
    if (distanceSquared == 0 and (this->radius == other.radius))
    {
        ...
        distanceSquared > (this->radius + other.radius) * (this->radius + other.radius) or
    ...
    else if (distanceSquared == (this->radius + other.radius) * (this->radius + other.radius))
    {
        ...
        float scale =
            static_cast<float>(this->radius) / static_cast<float>(this->radius + other.radius);
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Circle2D<T>::getIntersections(const Line2D<T>& line, PointSet2D<T>& intersections) const
{
...
// ----------------------------------------------------------------------------
template <typename T>
bool modm::Circle2D<T>::getIntersections(const LineSegment2D<T>& line, PointSet2D<T>& intersections)
    const
{
    return line.getIntersections(*this, intersections);
}

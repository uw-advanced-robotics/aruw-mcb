...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
const modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::identityMatrix()
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
const modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::zeroMatrix()
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
bool modm::Matrix<T, ROWS, COLUMNS>::operator==(const modm::Matrix<T, ROWS, COLUMNS> &m) const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, 1, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::getRow(uint8_t index) const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, 1> modm::Matrix<T, ROWS, COLUMNS>::getColumn(uint8_t index) const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
T *modm::Matrix<T, ROWS, COLUMNS>::operator[](uint8_t row)
{
    return &element[row * COLUMNS];
}

template <typename T, uint8_t ROWS, uint8_t COLUMNS>
const T *modm::Matrix<T, ROWS, COLUMNS>::operator[](uint8_t row) const
{
    return &element[row * COLUMNS];
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
uint8_t modm::Matrix<T, ROWS, COLUMNS>::getNumberOfRows() const
{
    return ROWS;
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
uint8_t modm::Matrix<T, ROWS, COLUMNS>::getNumberOfColumns() const
{
    return COLUMNS;
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
const T *modm::Matrix<T, ROWS, COLUMNS>::ptr() const
{
    return element;
}

template <typename T, uint8_t ROWS, uint8_t COLUMNS>
T *modm::Matrix<T, ROWS, COLUMNS>::ptr()
{
    return element;
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::operator-()
{
...
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::operator-(
    const modm::Matrix<T, ROWS, COLUMNS> &rhs) const
{
    modm::Matrix<T, ROWS, COLUMNS> m;
...
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::operator+=(
    const modm::Matrix<T, ROWS, COLUMNS> &rhs)
{
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
...
modm::Matrix<T, ROWS, RHSCOL> modm::Matrix<T, ROWS, COLUMNS>::operator*(
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::operator*(const T &rhs) const
{
    modm::Matrix<T, ROWS, COLUMNS> m;
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::operator*=(const T &rhs)
{
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
        element[i] *= rhs;
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, COLUMNS, ROWS> modm::Matrix<T, ROWS, COLUMNS>::asTransposed() const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
inline T modm::Matrix<T, ROWS, COLUMNS>::determinant() const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
bool modm::Matrix<T, ROWS, COLUMNS>::hasNan() const
{
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
        if (isnan(element[i]))
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
bool modm::Matrix<T, ROWS, COLUMNS>::hasInf() const
{
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
        if (isinf(element[i]))
...
modm::Matrix<T, WIDTH, HEIGHT> operator*(int8_t lhs, const modm::Matrix<T, WIDTH, HEIGHT> &m)
{
    return m * lhs;
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t WIDTH, uint8_t HEIGHT>
modm::Matrix<T, WIDTH, HEIGHT> operator*(float lhs, const modm::Matrix<T, WIDTH, HEIGHT> &m)
{
    return m * lhs;
}
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
size_t modm::Matrix<T, ROWS, COLUMNS>::getSize() const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
uint8_t modm::Matrix<T, ROWS, COLUMNS>::getNumberOfElements() const
{
    return ROWS * COLUMNS;
}
...
modm::Matrix<T, MR, MC> modm::Matrix<T, ROWS, COLUMNS>::subMatrix(uint8_t row, uint8_t column) const
{
...
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
template <typename U>
modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::replace(const U *data)
{
    for (uint_fast8_t i = 0; i < getNumberOfElements(); ++i)
    {
        element[i] = data[i];
...
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
template <uint8_t MR, uint8_t MC>
modm::Matrix<T, ROWS, COLUMNS> &modm::Matrix<T, ROWS, COLUMNS>::replace(
    uint8_t row,
    uint8_t column,
    const modm::Matrix<T, MR, MC> &m)
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS + 1, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::addRow(
    uint8_t index,
    const modm::Matrix<T, 1, COLUMNS> &r) const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS + 1> modm::Matrix<T, ROWS, COLUMNS>::addColumn(
    uint8_t index,
    const modm::Matrix<T, ROWS, 1> &c) const
{
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS - 1, COLUMNS> modm::Matrix<T, ROWS, COLUMNS>::removeRow(uint8_t index) const
{
    if (index == 0)
    {
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::Matrix<T, ROWS, COLUMNS - 1> modm::Matrix<T, ROWS, COLUMNS>::removeColumn(uint8_t index) const
{
    if (index == 0)
    {
...
// ----------------------------------------------------------------------------
template <typename T, uint8_t ROWS, uint8_t COLUMNS>
modm::IOStream &modm::operator<<(modm::IOStream &os, const modm::Matrix<T, ROWS, COLUMNS> &m)
{
    os << "{ ";

...
// ----------------------------------------------------------------------------
template <typename T>
modm::filter::Median<T, 7>::Median(const T& initialValue) : index(0)
{
...
template <typename T>
void modm::filter::Median<T, 7>::append(const T& input)
{
...
template <typename T>
void modm::filter::Median<T, 7>::update()
{
...
template <typename T>
const T modm::filter::Median<T, 7>::getValue() const
{
    return sorted[3];
}

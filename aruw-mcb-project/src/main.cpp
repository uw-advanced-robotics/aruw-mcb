...
#if defined(ALL_STANDARDS) || defined(TARGET_HIMO_PERSEUS)
...
#if defined(ALL_STANDARDS) || defined(TARGET_HIMO_PERSEUS) || defined(TARGET_SENTRY_HYDRA)
...
#if defined(TARGET_HIMO_PERSEUS) || defined(ALL_STANDARDS) || defined(TARGET_SENTRY_HYDRA)
...
#endif
#if defined(TARGET_HIMO_PERSEUS) || defined(ALL_STANDARDS)

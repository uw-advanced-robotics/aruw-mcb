...
{
inline constexpr uint32_t MARIO_MUSHROOM_NOTE_LENGTH_MS = 34;
inline constexpr std::array<uint8_t, 27> MARIO_MUSHROOM_NOTES{{37, 32, 37, 41, 44, 49, 44, 33, 37,
                                                               40, 45, 40, 45, 49, 52, 57, 52, 35,
                                                               39, 42, 47, 42, 47, 51, 54, 59, 54}};

inline constexpr uint32_t MARIO_1UP_NOTE_LENGTH_MS = 130;
inline constexpr std::array<uint8_t, 6> MARIO_1UP_NOTES{{41, 44, 53, 49, 51, 56}};

// https://onlinesequencer.net/3348282#t16
inline constexpr uint32_t MARIO_PIPE_NOTE_LENGTH_MS = 20;
inline constexpr std::array<uint8_t, 48> MARIO_PIPE_NOTES{
    {53, 46, 39, 53, 46, 39, 32, 25, 18, 11, 0, 0, 0, 0, 0, 0,
     53, 46, 39, 53, 46, 39, 32, 25, 18, 11, 0, 0, 0, 0, 0, 0,
     53, 46, 39, 53, 46, 39, 32, 25, 18, 11, 0, 0, 0, 0, 0, 0}};

inline constexpr uint32_t ZELDA_SECRET_NOTE_LENGTH_MS = 130;
inline constexpr std::array<uint8_t, 8> ZELDA_SECRET_NOTES{{44, 43, 40, 34, 33, 41, 45, 49}};

inline constexpr uint32_t MEGALOVANIA_NOTE_LENGTH_MS = 125;
inline constexpr std::array<uint8_t, 16> MEGALOVANIA_NOTES{
    {27, 27, 39, 0, 34, 0, 0, 33, 0, 32, 0, 30, 30, 27, 30, 32}};

inline constexpr uint32_t SEVEN_NATION_ARMY_NOTE_LENGTH_MS = 121;
inline constexpr std::array<uint8_t, 32> SEVEN_NATION_ARMY_NOTES{
    {27, 27, 27, 27, 27, 0,  27, 27, 30, 0,  0,  27, 0,  0,  25, 0,
     23, 23, 23, 23, 23, 23, 0,  0,  22, 22, 22, 22, 22, 22, 0,  0}};

inline constexpr uint32_t HES_A_PIRATE_NOTE_LENGTH_MS = 145;
inline constexpr std::array<uint8_t, 96> HES_A_PIRATE_NOTES{{
...
inline constexpr uint32_t UNKNOWN_RM_THEME_NOTE_LENGTH_MS = 800;
inline constexpr std::array<uint8_t, 16> UNKNOWN_RM_THEME_NOTES{
    {34, 42, 42, 42, 34, 39, 39, 39, 35, 44, 44, 44, 39, 41, 41, 41}};

inline constexpr uint32_t SUMMONING_GLORY_NOTE_LENGTH_MS = 215;
inline constexpr std::array<uint8_t, 64> SUMMONING_GLORY_NOTES{{
...
inline constexpr uint32_t FUNK_IN_KINGDOM_NOTE_LENGTH_MS = 130;
inline constexpr std::array<uint8_t, 32> FUNK_IN_KINGDOM_NOTES{
    {34, 0,  37, 0, 41, 0, 34, 32, 34, 0,  37, 41, 0,  0,  0,  34,
     0,  34, 37, 0, 41, 0, 37, 0,  39, 39, 39, 0,  37, 37, 37, 0}};

inline constexpr uint32_t BUMBLEBEE_NOTE_LENGTH_MS = 83;
inline constexpr std::array<uint8_t, 895> BUMBLEBEE_NOTES = {
...
inline constexpr uint32_t IMU_CALIBRATE_SUCCESS_NOTE_LENGTH_MS = MARIO_MUSHROOM_NOTE_LENGTH_MS;
inline constexpr auto& IMU_CALIBRATE_SUCCESS_NOTES = MARIO_MUSHROOM_NOTES;

inline constexpr uint32_t IMU_CALIBRATE_FAIL_NOTE_LENGTH_MS = 40;
inline constexpr std::array<uint8_t, 16> IMU_CALIBRATE_FAIL_NOTES{

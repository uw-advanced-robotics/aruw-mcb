...
#include "aruwsrc/algorithms/odometry/otto_chassis_velocity_displacement_2d_observer.hpp"
 ...
 */
class Odometry2DSubsystem final : public tap::control::Subsystem, public aruwsrc::chassis::ChassisOdometry<0,4>
{
public:
    /**
    ...
    Odometry2DSubsystem(
        ...
        const aruwsrc::chassis::ChassisOdometry<0,4>& chassisOdometry);

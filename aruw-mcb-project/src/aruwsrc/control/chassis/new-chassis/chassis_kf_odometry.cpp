...
void ChassisKFOdometry::update()
{
    ...
    y[int(OdomInput::VEL_X_W1)] = wheels[0]->getDriveVelocity();
    y[int(OdomInput::VEL_X_W2)] = wheels[1]->getDriveVelocity();
    y[int(OdomInput::VEL_X_W3)] = wheels[2]->getDriveVelocity();
    y[int(OdomInput::VEL_X_W4)] = wheels[3]->getDriveVelocity();

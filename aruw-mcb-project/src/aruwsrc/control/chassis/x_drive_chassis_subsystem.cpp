...
void XDriveChassisSubsystem::initialize()
{
...
void XDriveChassisSubsystem::setDesiredOutput(float x, float y, float r)
{
...
void XDriveChassisSubsystem::refresh()
{
    for (int i = 0; i < getNumChassisMotors(); i++)
    {
...
void XDriveChassisSubsystem::limitChassisPower()
{
...
void XDriveChassisSubsystem::mecanumDriveCalculate(float x, float y, float r, float maxWheelSpeed)
{
...
void XDriveChassisSubsystem::updateMotorRpmPid(
    modm::Pid<float>* pid,
...
modm::Matrix<float, 3, 1> XDriveChassisSubsystem::getActualVelocityChassisRelative() const
{

...
{
public:
    static constexpr float CHASSIS_AUTOROTATE_PID_KP = -150.0f;
...
private:
    ...
    void updateAutorotateState(const tap::control::turret::TurretSubsystemInterface* turret, const float turretAngleFromCenter);

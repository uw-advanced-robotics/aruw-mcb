 ...
 */
static constexpr float AUTOROTATION_PID_KP = 6'500.0f;
static constexpr float AUTOROTATION_PID_KD = 55.0f;
static constexpr float AUTOROTATION_PID_MAX_P = 8'000.0f;
...
static constexpr float
    BEYBLADE_TRANSLATIONAL_SPEED_THRESHOLD_MULTIPLIER_FOR_ROTATION_SPEED_DECREASE = 0.2f;

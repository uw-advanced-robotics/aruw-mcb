...
public:
    ...
    inline int16_t getLeftFrontRpmActual() const { return leftWheel.getShaftRPM(); }
    inline int16_t getLeftBackRpmActual() const { return 0; }
    inline int16_t getRightFrontRpmActual() const { return 0; }
    inline int16_t getRightBackRpmActual() const { return 0; }

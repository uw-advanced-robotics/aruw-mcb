...
#ifndef DUAL_BARREL_REF_SYSTEM_PROJECTILE_LAUNCHED_GOVERNOR_HPP_
#define DUAL_BARREL_REF_SYSTEM_PROJECTILE_LAUNCHED_GOVERNOR_HPP_
...
#endif  // DUAL_BARREL_REF_SYSTEM_PROJECTILE_LAUNCHED_GOVERNOR_HPP_

...
MoveAbsoluteCommand agitatorTopMoveCommandZero(&agitatorTop, AGITATOR_TARGET_ANGLE_ZERO, DART_ANGULAR_SPEED, DART_TOLERANCE, true);

MoveAbsoluteCommand agitatorTopMoveCommandOne(&agitatorTop, AGITATOR_TARGET_ANGLE_ONE, DART_ANGULAR_SPEED, DART_TOLERANCE, true);

MoveAbsoluteCommand agitatorTopMoveCommandTwo(&agitatorTop, AGITATOR_TARGET_ANGLE_TWO, DART_ANGULAR_SPEED, DART_TOLERANCE, true);

MoveAbsoluteCommand agitatorBottomMoveCommandZero(&agitatorBottom, AGITATOR_TARGET_ANGLE_ZERO, DART_ANGULAR_SPEED, DART_TOLERANCE, true);

MoveAbsoluteCommand agitatorBottomMoveCommandOne(&agitatorBottom, AGITATOR_TARGET_ANGLE_ONE, DART_ANGULAR_SPEED, DART_TOLERANCE, true);

MoveAbsoluteCommand agitatorBottomMoveCommandTwo(&agitatorBottom, AGITATOR_TARGET_ANGLE_TWO, DART_ANGULAR_SPEED, DART_TOLERANCE, true);
...
HoldCommandMapping leftSwitchMid(
    drivers(),
    {&agitatorBottomMoveCommandOne, &agitatorTopMoveCommandOne},
    RemoteMapState(Remote::Switch::LEFT_SWITCH, Remote::SwitchState::MID));

HoldCommandMapping leftSwitchUp(
    drivers(),
    {&agitatorBottomMoveCommandTwo, &agitatorTopMoveCommandTwo},

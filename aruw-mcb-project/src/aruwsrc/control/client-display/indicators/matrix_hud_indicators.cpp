...
MatrixHudIndicators::MatrixHudIndicators(
    ...
    : HudIndicator(refSerialTransmitter),
      ...
      heroAmmoLimitSwitch(heroAmmoLimitSwitch),
...
modm::ResumableResult<void> MatrixHudIndicators::sendInitialGraphics()
{
    RF_BEGIN(0);
...
modm::ResumableResult<void> MatrixHudIndicators::update()
{
    RF_BEGIN(1);
...
void MatrixHudIndicators::updateIndicatorState()
{
    ...
    if (shooterState == ShooterState::READY_TO_FIRE)
    {
        ...
        assert(heroAmmoLimitSwitch != nullptr);
        if (!heroAmmoLimitSwitch->getLimitSwitchDepressed())
        {

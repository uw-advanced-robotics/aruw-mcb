 ...
 */
class PrimeIndicator : public HudIndicator, protected modm::Resumable<2>
{
public:
    /**
     * Construct a PrimeIndicator object.
     *
...
// X position of the text
    ...
    static constexpr uint16_t TEXT_Y = 155;
    // WIDTH of the text
...
// SIZE of the text
    ...
    const char *bulletsRemainingText = "PRIME: ";
    ...
    static inline void updatePrimeDisplay(int32_t value, RefSerialData::Tx::Graphic1Message *graphic)
    {

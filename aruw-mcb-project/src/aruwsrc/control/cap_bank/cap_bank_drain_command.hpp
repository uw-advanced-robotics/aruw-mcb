...
#ifndef CAP_BANK_DRAIN_COMMAND_HPP_
#define CAP_BANK_DRAIN_COMMAND_HPP_
 ...
 */
class CapBankDrainCommand : public tap::control::Command
{
public:
    CapBankDrainCommand(
        tap::Drivers* drivers,
...
#endif  // CAP_BANK_DRAIN_COMMAND_HPP_

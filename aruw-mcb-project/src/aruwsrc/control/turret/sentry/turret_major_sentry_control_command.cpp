...
#include "turret_major_sentry_control_command.hpp"
...
void TurretMajorSentryControlCommand::execute()
{
    ...
    // const float yawSetpoint = controlOperatorInterface.getTurretMajorYawVelocity();
    // const float yawSetpoint = 0.0f;
    yawController->runController(dt, yawSetpoint);
}

bool TurretMajorSentryControlCommand::isFinished() const
{

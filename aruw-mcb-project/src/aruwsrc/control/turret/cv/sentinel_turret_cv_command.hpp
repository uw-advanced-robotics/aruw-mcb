...
private:
    ...
    static constexpr uint32_t AGITATOR_ROTATE_TIME = 50; // @TODO this also seems extremely low to me.
    ...
    static constexpr uint32_t AGITATOR_UNJAM_WAIT_TIME = 30;
    static constexpr uint_fast16_t AGITATOR_UNJAM_CYCLE_COUNT = 4;

...
TurretSubsystem::TurretSubsystem(aruwlib::Drivers* drivers)
    : aruwlib::control::Subsystem(drivers),
      pitchMotor(drivers, PITCH_MOTOR_ID, CAN_BUS_MOTORS, PITCH_MOTOR_INVERTED, "pitch motor"),
      yawMotor(drivers, YAW_MOTOR_ID, CAN_BUS_MOTORS, YAW_MOTOR_INVERTED, "yaw motor"),

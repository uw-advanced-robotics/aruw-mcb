...
public:
    ...
    /**
     * Runs a velocity PID controller to control the speed of the pitch/yaw gimbals, updating
     * velocity setpoint based on input from the control operator interface.
     */

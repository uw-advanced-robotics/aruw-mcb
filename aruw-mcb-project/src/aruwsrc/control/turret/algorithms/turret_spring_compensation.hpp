...
public:
    ...
    /**
     * @brief Calculate the effective moment arm of the spring force about the pitch axis.
     * Handles the projection of the spring vector and the resulting moment value to be later
     * multiplied by the spring constant. This is separated out for use in autotuning.
     *
     * @param[in] pitch The current pitch angle of the turret in radians.
     * @return The effective moment arm of the spring force about the pitch axis to be scaled by the
     * spring constant.
     */

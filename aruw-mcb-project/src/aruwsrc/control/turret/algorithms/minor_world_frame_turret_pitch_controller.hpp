...
#ifndef PMINOR_WORLD_FRAME_TURRET_IMU_TURRET_CONTROLLER_HPP_
#define PMINOR_WORLD_FRAME_TURRET_IMU_TURRET_CONTROLLER_HPP_
 ...
 */
class WorldFrameTurretPitchCascadePIDControllerMinor final : public TurretPitchControllerInterface
{
public:
    /**
    ...
    /// Sets the world frame pitch angle setpoint, refer to top level documentation for more details.
    ...
    inline float convertControllerAngleToChassisFrame(float controllerFrameAngle) const final {
        return controllerFrameAngle + turretMotor.getChassisFrameUnwrappedMeasuredAngle() - turretMCB.getPitchUnwrapped(); };

    inline float convertChassisAngleToControllerFrame(float chassisFrameAngle) const final { return chassisFrameAngle - turretMotor.getChassisFrameUnwrappedMeasuredAngle() + turretMCB.getPitchUnwrapped(); };

...
#ifndef MODULAR_FRICTION_WHEEL_SUBSYSTEM_HPP_
#define MODULAR_FRICTION_WHEEL_SUBSYSTEM_HPP_
...
#include "aruwsrc/control/launcher/friction_wheel_test_command.hpp"
 ...
 */
template<std::size_t NUM_WHEELS> class ModularFrictionWheelSubsystem : public tap::control::Subsystem
{
...
public:
    ...
    const char *getName() const override { return "Modular Friction wheels"; }
...
#endif  // MODULAR_FRICTION_WHEEL_SUBSYSTEM_HPP_

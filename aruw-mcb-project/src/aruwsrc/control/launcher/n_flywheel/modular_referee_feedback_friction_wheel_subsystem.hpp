...
#ifndef MODULAR_REFEREE_FEEDBACK_FRICTION_WHEEL_SUBSYSTEM_HPP_
#define MODULAR_REFEREE_FEEDBACK_FRICTION_WHEEL_SUBSYSTEM_HPP_
...
class ModularRefereeFeedbackFrictionWheelSubsystem : public ModularFrictionWheelSubsystem<NUM_WHEELS>,
                                              public LaunchSpeedPredictorInterface
{
public:
    /**
     * For all params but `firingSystemMechanismId` see the `ModularFrictionWheelSubsystem`.
     ...
     */
    ModularRefereeFeedbackFrictionWheelSubsystem(
        tap::Drivers *drivers,
    ...
    {
        ModularFrictionWheelSubsystem::refresh();
...
#endif  // MODULAR_REFEREE_FEEDBACK_FRICTION_WHEEL_SUBSYSTEM_HPP_

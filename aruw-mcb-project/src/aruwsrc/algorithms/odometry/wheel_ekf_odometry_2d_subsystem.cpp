...
#include "wheel_ekf_odometry_2d_subsystem.hpp"
...
WheelEKFOdometry2DSubsystem::WheelEKFOdometry2DSubsystem(
    ...
    : Subsystem(&drivers),
      FourWheelEKFOdometry(chassisMotors, yawObserver, imu, initPos, telemetry)
{
}

void WheelEKFOdometry2DSubsystem::refresh() { update(); }

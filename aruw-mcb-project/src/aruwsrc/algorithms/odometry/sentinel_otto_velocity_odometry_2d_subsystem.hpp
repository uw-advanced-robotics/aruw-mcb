...
#ifndef SENTINEL_OTTO_VELOCITY_ODOMETRY_2D_SUBSYSTEM_HPP_
#define SENTINEL_OTTO_VELOCITY_ODOMETRY_2D_SUBSYSTEM_HPP_
...
#endif  // SENTINEL_OTTO_VELOCITY_ODOMETRY_2D_SUBSYSTEM_HPP_

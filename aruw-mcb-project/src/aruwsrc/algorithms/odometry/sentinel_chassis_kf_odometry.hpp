...
private:
    ...
    static constexpr float CHASSIS_WHEEL_ACCELERATION_LOW_PASS_ALPHA = 0.01f; // TODO: Tune for sentinel 2022
    ...
    modm::interpolation::Linear<modm::Pair<float, float>> chassisAccelerationToCovarianceInterpolator;

    uint32_t prevTime = 0;
    float prevChassisVelocity;
    float deltaVelocity;

    void updateLocationVelocityFromKF();

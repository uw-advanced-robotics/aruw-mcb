...
private:
    ...
    const Position POINT_5 = Position(1,1,0);
    const Position POINT_6 = Position(1.5,1,0);
    ...
    const std::array<Position, 2> ATTACKING_PATH =
         {POINT_5, POINT_6};
    const std::array<Position, 2> HEALING_PATH =
         {POINT_5, POINT_6};

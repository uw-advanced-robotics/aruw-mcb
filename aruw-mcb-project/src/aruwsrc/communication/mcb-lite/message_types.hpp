...
enum MessageTypes : uint8_t
{
    ...
    LED_CONTROL_MESSAGE = 12
};

// IMU message coming from MCBLite
struct IMUMessage
{
...
// Digital messages being sent to MCBLite
...
// Analog message coming from MCBLite
...
// PWM messages are all being sent to MCBLite
...
// LED messages are all being sent to MCBLite

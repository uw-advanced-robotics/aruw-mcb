...
private:
    ...
    static constexpr uint8_t DEFAULT_CTRL1_XL_VALUE = static_cast<uint8_t>(DEFAULT_ODR) | DEFAULT_ACCEL_RANGE;
    static constexpr uint8_t DEFAULT_CTRL2_G_VALUE = static_cast<uint8_t>(DEFAULT_ODR) | DEFAULT_GYRO_RANGE;

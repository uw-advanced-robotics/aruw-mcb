...
#ifndef INTER_ROBOT_MESSAGE_TRANSMITTER_HPP_
#define INTER_ROBOT_MESSAGE_TRANSMITTER_HPP_
...
struct InterRobotMessage
{
} modm_packed;

/**
 * An inter-robot transmitter sends messages with payloads to a specified list of targets
 */
template <typename MSG_TYPE_ENUM, uint8_t NUM_MSG_TYPES>
class InterRobotMessageTransmitter : public modm::pt::Protothread
{
...
public:
    inline InterRobotMessageTransmitter(
        tap::Drivers &drivers,
...
#endif  // INTER_ROBOT_MESSAGE_TRANSMITTER_HPP_

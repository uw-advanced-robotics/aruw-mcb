...
#ifndef SENTINEL_REQUEST_TRANSMITTER_HPP_
#define SENTINEL_REQUEST_TRANSMITTER_HPP_
...
{
class SentinelRequestTransmitter : public modm::pt::Protothread
{
public:
    SentinelRequestTransmitter(aruwsrc::Drivers *drivers);

    bool send();

    void queueRequest(SentinelRequestMessageType type);
...
private:
    ...
    SentinelRequestMessageType lastSentMessage = SentinelRequestMessageType::SELECT_NEW_ROBOT;
...
#endif  // SENTINEL_REQUEST_TRANSMITTER_HPP_

...
#ifndef HERO_LAUNCHER_CONSTANTS_HPP_
#define HERO_LAUNCHER_CONSTANTS_HPP_
...
#error "Attempted to include hero_launcher_constants.hpp for non-hero target."
#endif
...
#endif  // HERO_LAUNCHER_CONSTANTS_HPP_

...
#ifndef SENTRY_CHASSIS_KF_ODOMETRY_HPP_
#define SENTRY_CHASSIS_KF_ODOMETRY_HPP_
 ...
 */
class SentryChassisKFOdometry : public tap::algorithms::odometry::Odometry2DInterface
{
public:
    /**

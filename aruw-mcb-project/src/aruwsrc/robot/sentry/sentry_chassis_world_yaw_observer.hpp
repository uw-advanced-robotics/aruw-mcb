...
public:
    ...
    SentryChassisWorldYawObserver(
        ...
        const aruwsrc::control::turret::TurretSubsystem& turretMinorMalewifeSubsystem);  // Could do sensor fusion in the future but for now the malewife turret is unused

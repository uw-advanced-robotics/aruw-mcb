...
#ifndef DRONE_TRANSFORMER_SUBSYSTEM_HPP_
#define DRONE_TRANSFORMER_SUBSYSTEM_HPP_
...
{
class DroneTransformerSubsystem : public tap::control::Subsystem
{
public:
    DroneTransformerSubsystem(tap::Drivers& drivers, DroneTransformer& transformer)
...
private:
    DroneTransformer& transformer;
};
}  // namespace aruwsrc::drone

#endif  // DRONE_TRANSFORMER_SUBSYSTEM_HPP_

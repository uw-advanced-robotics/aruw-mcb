 ...
 */
static constexpr float parallelOneCenterToWheelDistance = 0.079375f;
static constexpr float parallelTwoCenterToWheelDistance = 0.079375f;
static constexpr float perpendicularCenterToWheelDistance = 0.1524f;
/**

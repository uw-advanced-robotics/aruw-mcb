 ...
 */
static constexpr float parallelOneCenterToWheelDistance = 0.0f; //TODO: measure distance from center to deadwheel.
static constexpr float parallelTwoCenterToWheelDistance = 0.0f; //TODO: measure distance from center to deadwheel one.
static constexpr float perpendicularCenterToWheelDistance = 0.0f; //TODO: measure distance from center to deadwheel one.
/**
 * Relative orientation of dead wheels (rad)
 */
static constexpr float parallelWheelOneChassisForwardRelativeAngleRadians = 0.0f; //TODO: measure distance from center to deadwheel one.
static constexpr float parallelWheelTwoChassisForwardRelativeAngleRadians = 0.0f; //TODO: measure distance from center to deadwheel one.
static constexpr float perpendicularWheelChassisForwardRelativeAngleRadians = 0.0f; //TODO: measure distance from center to deadwheel one.
/**

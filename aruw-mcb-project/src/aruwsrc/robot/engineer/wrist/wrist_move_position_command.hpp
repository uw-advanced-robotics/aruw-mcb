...
{
public:
    static constexpr float WRIST_MOVE_POSITION_COMMAND_RAMP_RATE = 0.005f;
    static constexpr float WRIST_MOVE_POSITION_COMMAND_RAMP_EPSILON = 0.2f;
...
private:
    ...
    tap::algorithms::WrappedFloat currPitchSetpoint, currYawSetpoint;

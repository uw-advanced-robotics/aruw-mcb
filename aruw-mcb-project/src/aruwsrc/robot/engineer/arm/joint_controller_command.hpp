...
#ifndef JOINT_CONTROLLER_COMMAND_HPP_
#define JOINT_CONTROLLER_COMMAND_HPP_
...
public:
    ...
    const char *getName() const override { return "Engineer Joint Controller Command"; };
...
#endif  // JOINT_CONTROLLER_COMMAND_HPP_
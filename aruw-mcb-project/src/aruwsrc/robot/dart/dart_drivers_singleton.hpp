...
#ifndef DART_DRIVERS_SINGLETON_HPP_
#define DART_DRIVERS_SINGLETON_HPP_
 ...
 */
aruwsrc::DartDrivers *DoNotUse_getDartDrivers();
using dartDriversFunc = aruwsrc::DartDrivers *(*)();
}  // namespace aruwsrc

#endif

#endif  // DART_DRIVERS_SINGLETON_HPP_

...
#ifndef BALSTD_IMU_CALIBRATE_COMMAND_HPP_
#define BALSTD_IMU_CALIBRATE_COMMAND_HPP_
...
#include "chassis/balstd_chassis_subsystem.hpp"
 ...
 */
class BalstdImuCalibrateCommand : public tap::control::Command
{
public:
    /**

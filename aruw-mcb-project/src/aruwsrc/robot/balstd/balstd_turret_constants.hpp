...
#ifndef BALSTD_TURRET_CONSTANTS_HPP_
#define BALSTD_TURRET_CONSTANTS_HPP_
...
static constexpr TurretMotorConfig YAW_MOTOR_CONFIG = {
    .startAngle = 0,
    .startEncoderValue = 970,
    .minAngle = 0,
    .maxAngle = M_PI,
    .limitMotorAngles = false,
};
static constexpr float CHASSIS_FALL_OVER_OFFSET = modm::toRadian(24.45);
static constexpr TurretMotorConfig PITCH_MOTOR_CONFIG = {
    .startAngle = M_PI_2 - CHASSIS_FALL_OVER_OFFSET,
    .startEncoderValue = 6905,
...
static constexpr tap::algorithms::SmoothPidConfig PITCH_VEL_PID_AUTO_AIM_CONFIG = {
    .kp = 16'000.0f,
    .ki = 0.0f,
    .kd = 0.0f,
    .maxICumulative = 0.0f,
...
#endif  // BALSTD_TURRET_CONSTANTS_HPP_

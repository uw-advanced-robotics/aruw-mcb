...
#ifndef AUTOSTANDARD_TURRET_CV_COMMAND_HPP_
#define AUTOSTANDARD_TURRET_CV_COMMAND_HPP_
 ...
 */
class AutostandardTurretCVCommand : public tap::control::Command
{
public:
    struct TurretConfig
    {
    ...
    static constexpr float SCAN_TURRET_PITCH = modm::toRadian(10.0f);
...
private:
    ...
    tap::algorithms::WrappedFloat scanValue = Angle(0);
...
#endif  // AUTOSTANDARD_TURRET_CV_COMMAND_HPP_

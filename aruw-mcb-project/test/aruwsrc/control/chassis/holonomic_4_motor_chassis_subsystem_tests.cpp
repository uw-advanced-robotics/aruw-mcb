...
TEST_F(Holonomic4MotorChassisSubsystemTest, setZeroRPM_doesnt_reset_desired_velocity)
{
    chassis.setDesiredOutput(0, 0, CHASSIS_VEL);
    chassis.setZeroRPM();
    EXPECT_NEAR(CHASSIS_VEL, chassis.getDesiredRotation(), 1E-3);
...
TEST_F(Holonomic4MotorChassisSubsystemTest, calculateRotationTranslationalGain_0_rotation)
{
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(0), 1E-3);
}

TEST_F(Holonomic4MotorChassisSubsystemTest, calculateRotationTranslationalGain_almost_0_rotation)
{
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(MIN_ROTATION_THRESHOLD), 1E-3);
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(-MIN_ROTATION_THRESHOLD), 1E-3);
}

TEST_F(Holonomic4MotorChassisSubsystemTest, calculateRotationTranslationalGain_max_velocity)
{
    EXPECT_NEAR(
...
TEST_F(Holonomic4MotorChassisSubsystemTest, calculateRotationTranslationalGain_gt_max_velocity)
{
    EXPECT_NEAR(
        0,
...
TEST_F(Holonomic4MotorChassisSubsystemTest, calculateRotationTranslationalGain_half_rotation)
{
    EXPECT_THAT(
...
TEST_F(Holonomic4MotorChassisSubsystemTest, chassisSpeedRotationPID_basic_validation)
{
...
class VelocityGetterTest : public Holonomic4MotorChassisSubsystemTest,
...
class ActualVelocityTest : public Holonomic4MotorChassisSubsystemTest,
                           public WithParamInterface<ActualVelocityParam>
{
public:
    void SetUp() override
    {
        Holonomic4MotorChassisSubsystemTest::SetUp();

...
TEST_F(MecanumChassisSubsystemTest, getDesiredRotation_returns_desired_rotation)
{
    chassis.setDesiredOutput(0, 0, CHASSIS_VEL);
    EXPECT_NEAR(CHASSIS_VEL, chassis.getDesiredRotation(), 1E-3);
}

TEST_F(MecanumChassisSubsystemTest, setZeroRPM_doesnt_reset_desired_velocity)
{
    chassis.setDesiredOutput(0, 0, CHASSIS_VEL);
    chassis.setZeroRPM();
    EXPECT_NEAR(CHASSIS_VEL, chassis.getDesiredRotation(), 1E-3);
...
TEST_F(MecanumChassisSubsystemTest, allMotorsOnline)
{
...
TEST_F(MecanumChassisSubsystemTest, onHardwareTestStart_sets_desired_out_0)
{
...
TEST_F(MecanumChassisSubsystemTest, calculateRotationTranslationalGain_0_rotation)
{
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(0), 1E-3);
}

TEST_F(MecanumChassisSubsystemTest, calculateRotationTranslationalGain_almost_0_rotation)
{
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(MIN_ROTATION_THRESHOLD), 1E-3);
    EXPECT_NEAR(1, chassis.calculateRotationTranslationalGain(-MIN_ROTATION_THRESHOLD), 1E-3);
}

TEST_F(MecanumChassisSubsystemTest, calculateRotationTranslationalGain_max_velocity)
{
    EXPECT_NEAR(
...
TEST_F(MecanumChassisSubsystemTest, calculateRotationTranslationalGain_gt_max_velocity)
{
    EXPECT_NEAR(
        0,
...
TEST_F(MecanumChassisSubsystemTest, calculateRotationTranslationalGain_half_rotation)
{
    EXPECT_THAT(
...
TEST_F(MecanumChassisSubsystemTest, chassisSpeedRotationPID_basic_validation)
{
...
class VelocityGetterTest : public MecanumChassisSubsystemTest,
...
class ActualVelocityTest : public MecanumChassisSubsystemTest,
                           public WithParamInterface<ActualVelocityParam>
{
public:
    void SetUp() override
    {
        MecanumChassisSubsystemTest::SetUp();

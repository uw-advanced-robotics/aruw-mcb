...
{
    tap::Drivers drivers;
    aruwsrc::mock::TurretMotorMock pitchMotorMock1(nullptr, DUMMY_TURRET_MOTOR_CONFIG);
    aruwsrc::mock::TurretMotorMock yawMotorMock1(nullptr, DUMMY_TURRET_MOTOR_CONFIG);
    TurretSubsystemMock turret1(&drivers, pitchMotorMock1, yawMotorMock1, nullptr);
    aruwsrc::mock::TurretMotorMock pitchMotorMock2(nullptr, DUMMY_TURRET_MOTOR_CONFIG);
    aruwsrc::mock::TurretMotorMock yawMotorMock2(nullptr, DUMMY_TURRET_MOTOR_CONFIG);

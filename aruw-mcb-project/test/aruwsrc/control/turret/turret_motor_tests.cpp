    ...
    getMeasuredYawValue__returns_values_based_on_enc_position_if_yaw_motor_online)
{
    ...
    std::vector<std::tuple<float, int>> angleAndEncoderPairs{
        ...
        {modm::toRadian(180), TURRET_MOTOR_CONFIG.startEncoderValue + 2 * DjiMotor::ENC_RESOLUTION / 8},
        {modm::toRadian(225), TURRET_MOTOR_CONFIG.startEncoderValue + 3 * DjiMotor::ENC_RESOLUTION / 8},
        {modm::toRadian(270), TURRET_MOTOR_CONFIG.startEncoderValue + 4 * DjiMotor::ENC_RESOLUTION / 8},
        {modm::toRadian(315), TURRET_MOTOR_CONFIG.startEncoderValue + 5 * DjiMotor::ENC_RESOLUTION / 8},
        {modm::toRadian(0), TURRET_MOTOR_CONFIG.startEncoderValue + 6 * DjiMotor::ENC_RESOLUTION / 8}};
...
TEST_F(TurretMotorTest, getAngleFromCenter__valid_encoder_angles)
{
    std::vector<std::tuple<float, int>> angleAndEncoderPairs{
        ...
        // {modm::toRadian(90), TURRET_MOTOR_CONFIG.startEncoderValue + 2 * DjiMotor::ENC_RESOLUTION / 8},
        // {modm::toRadian(135), TURRET_MOTOR_CONFIG.startEncoderValue + 3 * DjiMotor::ENC_RESOLUTION / 8},
        // {modm::toRadian(180), TURRET_MOTOR_CONFIG.startEncoderValue + 4 * DjiMotor::ENC_RESOLUTION / 8},
        // {modm::toRadian(-135), TURRET_MOTOR_CONFIG.startEncoderValue + 5 * DjiMotor::ENC_RESOLUTION / 8},
        // {modm::toRadian(-90), TURRET_MOTOR_CONFIG.startEncoderValue + 6 * DjiMotor::ENC_RESOLUTION / 8}};
...
TEST_F(
    TurretMotorTest,
    setMotorOutput__desired_output_not_limited_if_equal_to_min_max_bound)
{
    uint16_t minEncoderValue =
        tap::algorithms::ContiguousFloat(
            TURRET_MOTOR_CONFIG.startEncoderValue +
                +(TURRET_MOTOR_CONFIG.minAngle - TURRET_MOTOR_CONFIG.startAngle) * DjiMotor::ENC_RESOLUTION / M_TWOPI + 1,
            0,
    ...
    uint16_t maxEncoderValue =
        tap::algorithms::ContiguousFloat(
            TURRET_MOTOR_CONFIG.startEncoderValue +
                +(TURRET_MOTOR_CONFIG.maxAngle - TURRET_MOTOR_CONFIG.startAngle) * DjiMotor::ENC_RESOLUTION / M_TWOPI - 1,
            0,
            DjiMotor::ENC_RESOLUTION)
            .getValue();
    ...
    setMotorOutput__desired_output_0_if_out_of_bounds_and_input_des_output_wrong_way)
{
    uint16_t lessThanMinEncoderValue =
        tap::algorithms::ContiguousFloat(
            TURRET_MOTOR_CONFIG.startEncoderValue +
                +(TURRET_MOTOR_CONFIG.minAngle - TURRET_MOTOR_CONFIG.startAngle - 10) * DjiMotor::ENC_RESOLUTION / M_TWOPI,
            0,
            DjiMotor::ENC_RESOLUTION)
            .getValue();
    ...
    uint16_t greaterThanMaxEncoderValue =
        tap::algorithms::ContiguousFloat(
            TURRET_MOTOR_CONFIG.startEncoderValue +
                +(TURRET_MOTOR_CONFIG.maxAngle - TURRET_MOTOR_CONFIG.startAngle + 10) * DjiMotor::ENC_RESOLUTION / M_TWOPI,
            0,
            DjiMotor::ENC_RESOLUTION)
            .getValue();
...
TEST_F(TurretMotorTest, updateMotorAngle_sets_actual_angle_back_to_start_when_offline)
{
    ...
    EXPECT_NE(TURRET_MOTOR_CONFIG.startAngle, turretMotor.getChassisFrameMeasuredAngle().getValue());

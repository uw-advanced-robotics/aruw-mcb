...
TEST(TurretMCBCanComm, sendData_hopper_cover_data)
{
    ...
    modm::can::Message blankMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(0)}, false);
    modm::can::Message filledMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(1)}, false);
...
TEST(TurretMCBCanComm, sendData_calibrate_imu_data)
{
    ...
    modm::can::Message blankMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(0)}, false);
    modm::can::Message filledMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(0b10)}, false);
...
TEST(TurretMCBCanComm, sendData_laser_data)
{
    ...
    modm::can::Message blankMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(0)}, false);
    modm::can::Message filledMsg(TurretMCBCanComm::CanIDs::TURRET_MCB_TX_CAN_ID, 1, {static_cast<uint8_t>(0b100)}, false);
...
TEST(TurretMCBCanComm, receive_turret_data)
{
    ...
    modm::can::Message xAxisMessage(TurretMCBCanComm::CanIDs::X_AXIS_RX_CAN_ID, 8);
    modm::can::Message yAxisMessage(TurretMCBCanComm::CanIDs::Y_AXIS_RX_CAN_ID, 8);
    modm::can::Message zAxisMessage(TurretMCBCanComm::CanIDs::Z_AXIS_RX_CAN_ID, 8);
...
TEST(TurretMCBCanComm, sendTimeSyncData)
{
    ...
    modm::can::Message syncReqMessage(TurretMCBCanComm::CanIDs::SYNC_RX_CAN_ID, 4);
    syncReqMessage.setExtended(false);
    ...
    modm::can::Message syncMessage(TurretMCBCanComm::CanIDs::SYNC_TX_CAN_ID, 4);
    syncMessage.setExtended(false);

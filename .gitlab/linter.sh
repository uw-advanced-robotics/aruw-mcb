...
listTests=(
  ...
  "cppcheck ./mcb-2019-2020-project/src ./mcb-2019-2020-project/robot-type ./mcb-2019-2020-project/rm-dev-board-a --suppress=unusedFunction:./mcb-2019-2020-project/* --suppress=knownConditionTrueFalse:./mcb-2019-2020-project/src/aruwsrc/control/chassis_subsystem.cpp --suppress=useStlAlgorithm:./mcb-2019-2020-project/src/aruwlib/errors/error_controller.cpp ./mcb-2019-2020-project/src/errors/ --rule-file=./.gitlab/rules.xml --inline-suppr --enable=all --error-exitcode=1 --template='[{file}:{line}] ({severity}) ({id}) {message}'"
)

...
public:
    ...
    MOCK_METHOD(const aruwlib::motor::DjiMotor *, getCan1MotorData, (aruwlib::motor::MotorId motorId), (override));
    MOCK_METHOD(const aruwlib::motor::DjiMotor *, getCan2MotorData, (aruwlib::motor::MotorId motorId), (override));

...
struct SystemClock
{
    ...
    static constexpr uint32_t PWM_FREQUENCY = 500_Hz;
    static constexpr uint32_t PWM_RESOLUTION = 31000;
    static constexpr uint32_t APB1_TIMER_CLOCKS = Apb1; // 48150000;
    static constexpr uint32_t APB2_TIMER_CLOCKS = Apb2; // 92500000;

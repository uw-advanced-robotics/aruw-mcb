...
private:
    ...
    static Game_Data_t game_data; /* game stats     (e.g. remaining time, current stage, winner)*/
    static Robot_Data_t robot_data; /* robot stats    (e.g. current HP, power draw, turret info)*/

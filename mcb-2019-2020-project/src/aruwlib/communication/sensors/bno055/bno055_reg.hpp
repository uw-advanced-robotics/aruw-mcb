...
struct Bno055Enum
{
 ...
 public:
    ...
    AccConfig : uint8_t
    {
        AccPowerMode_Mask = modm::Bit7 | modm::Bit6 | modm::Bit5,
        AccBandwidth_Mask = modm::Bit4 | modm::Bit3 | modm::Bit2,
        AccRange_Mask = modm::Bit1 | modm::Bit0,
    };
    ...
    MagConfig : uint8_t
    {
        MagPowerMode_Mask = modm::Bit6 | modm::Bit5,
        MagOperationMode_Mask = modm::Bit4 | modm::Bit3,
        MagDataOutputRate_Mask = modm::Bit2 | modm::Bit1 | modm::Bit0,
    };
    ...
    GyrConfig0 : uint8_t
    {
        GyrBandwidth_Mask = modm::Bit5 | modm::Bit4 | modm::Bit3,
        GyrRange_Mask = modm::Bit2 | modm::Bit1 | modm::Bit0,
    };
    ...
    GyrConfig1 : uint8_t
    {
        GyrPowerMode_Mask = modm::Bit2 | modm::Bit1 | modm::Bit0,
    };

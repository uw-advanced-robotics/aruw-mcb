...
{
public:
    ContiguousFloatProperty() : BaseProperty(), data(aruwlib::algorithms::ContiguousFloat(0.0, 0.0, 0.0)) {}
    ContiguousFloatProperty(aruwlib::algorithms::ContiguousFloat data) : data(data) {}
    ContiguousFloatProperty(aruwlib::algorithms::ContiguousFloat data, const char* name) : BaseProperty(name), data(data) {}
    ContiguousFloatProperty(const ContiguousFloatProperty& other) = default;
    ContiguousFloatProperty(float val, float min, float max) : data(aruwlib::algorithms::ContiguousFloat(val, min, max)) {}

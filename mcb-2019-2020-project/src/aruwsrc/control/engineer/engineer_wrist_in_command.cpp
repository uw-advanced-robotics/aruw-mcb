#include "engineer_wrist_in_command.hpp"
...
namespace control
{
    EngineerWristInCommand::EngineerWristInCommand(
    ...
    void EngineerWristInCommand::initialize()
    {
    ...
    void EngineerWristInCommand::execute()
    {
    ...
    void EngineerWristInCommand::end(bool interrupted)
    {
    ...
    bool EngineerWristInCommand::isFinished() const
    {

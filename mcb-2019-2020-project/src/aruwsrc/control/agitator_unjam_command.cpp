...
void AgitatorUnjamCommand::initialize()
{
    ...
    currAgitatorUnjamAngle = fmod((fmod(static_cast<double>(rand()), static_cast<double>(agitatorUnjamAngleMax +
        MIN_AGITATOR_UNJAM_ANGLE))), static_cast<double>(agitatorUnjamAngleMax));

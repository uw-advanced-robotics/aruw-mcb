...
The recommended way to develop is with our pre-build development Docker container.
...
1. [Install Docker Desktop](https://docs.docker.com/get-docker/). The macOS and Linux instructions will work
   as-is. If you are on Windows, there are two options:
     ...
     - If you cannot update to Windows 10 version 2004 (recommended), you can follow [this guide](https://docs.docker.com/docker-for-windows/install/)
...
![image](https://gitlab.com/aruw/code-2019-2020/aruw-mcb-2019-2020/uploads/1e1f271fbda7085856d57e85491eae91/image.png)
6. Once it opens the new folder, an alert will appear with suggested extensions. Click "Install All".
![image](https://gitlab.com/aruw/code-2019-2020/aruw-mcb-2019-2020/uploads/edb88ab3074a99d5eed1a4b2a50b2e53/image.png)
7. vscode will now prompt you to open the development container. Choose "Reopen in Container". This
   ...
   patient.
![image](https://gitlab.com/aruw/code-2019-2020/aruw-mcb-2019-2020/uploads/198095587078b88d67ac674839cf4ad7/image.png)
  vscode is now attached to a "container", which contains all the tools
